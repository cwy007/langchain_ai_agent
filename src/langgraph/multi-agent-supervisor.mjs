...
const stream = await app.stream(input, {
  streamMode: ["updates", "values"] // 只关心 updates 和 values，其他事件不需要
});
...
// 西湖文化景观于2011年被联合国教科文组织列入《世界遗产名录》，是中国第41处世界遗产。它以"三面云山一面城"的独特格局，将自然山水与人文历史完美融合，千百年来令无数文人墨客流连忘返。
